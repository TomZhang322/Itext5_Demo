...
public class BaoXiaoDan {
    public static void main(String[] args) {
        ...
        try
        {
            ...
            PdfWriter.getInstance(document, new FileOutputStream("src/main/resources/pdf/Helloworld.PDF"));
            ...
            cell11.setBorder(0);
            String imagePath = "src/main/resources/images/alibaba.jpg";
            ...
            String imagePath2 = "src/main/resources/images/alibaba.jpg";
