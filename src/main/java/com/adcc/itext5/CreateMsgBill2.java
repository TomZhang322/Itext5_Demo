package com.adcc.itext5;

import com.adcc.itext5.util.PdfFileExportUtil;
import com.adcc.itext5.util.PdfReportM1HeaderFooter;
 ...
 * Itext5生成报文账单
 */
public class CreateMsgBill2 {
    public static final String DEST = "src/main/resources/pdf/MsgBill2.pdf";

    // 柱状图路径
    public static final String DESTBAR2 = "src/main/resources/images/msgRateBar2.jpg";
    // 饼图路径
    public static final String DESTPIE2 = "src/main/resources/images/msgRatePie2.jpg";

    public static void main(String[] args) throws IOException, DocumentException {
        File file = new File(DEST);
        file.getParentFile().mkdirs();
        new CreateMsgBill2().createPdf(DEST);
    }
...
//        costInfoTitle.setLeading(20f);
        ...
        //加入空行
        Paragraph blankRow1 = new Paragraph(40f, " ", getChineseFont(15));
...
//        }
        ...
        tableBar.addCell(createImageCell(DESTBAR2));
//        tableBar.setSkipFirstHeader(true);//换页
//        tableBar.setSplitLate(true);
        //加入空行
        Paragraph blankRow2 = new Paragraph(30f, " ", getChineseFont(15));
...
//        paragraphPieTitle.setLeading(50f);
        ...
        tablePier.addCell(createImageCell(DESTPIE2));
    ...
    private void createBar() {
        try {
            ...
            ChartUtilities.saveChartAsJPEG(new File(DESTBAR2), chart, 600, 300);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void createPie() {
        try {
            ...
            ChartUtilities.saveChartAsJPEG(new File(DESTPIE2), chart, 600, 300);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
