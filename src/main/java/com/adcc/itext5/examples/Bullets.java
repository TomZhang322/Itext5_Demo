...
public class Bullets {
    public static final String DEST = "E:\\Itext5PDF_Test\\examples\\bullets.pdf";
    ...
    public void createPdf(String dest) throws DocumentException, IOException {
        ...
        BaseFont bf = BaseFont.createFont("src/main/resources/fonts/FreeSans.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
